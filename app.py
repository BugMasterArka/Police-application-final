...
def giveFile():
    list_of_files = glob.glob('D:/SDH/last pull from sanjay/SDH_AGE_GENDER_CNN_VGG16/vgg16/static/uploads/*')
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        data = predictfile()
        flash("Name: "+ person_name)
        print(data[0])
        flash("Age: "+ str(data[0]))
        print(data[1])
        flash("Gender: "+ str(data[1]))
        return render_template('police.html',filename=filename)
    else:
